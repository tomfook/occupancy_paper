...
We suppose that we configure a single-rider queue.
A single-rider queue is a independent queue only for guests of group size 1.
...
$$
$$
\mathrm{E}[\mathrm{Occupancy}] = \frac{2p_2+3p_3+4p_4}{\frac{1}{1+p_2}+p_3+p_4}
$$
