...
plot_boundary(0.005, 0.1) + labs(title = "Simulation at p1=0.1", subtitle = "the boundary is independent on p1.")
```
...
The most strong constraint in the study was the one line seat configuration.
We can not apply Markov chain model for multiple line seat configuration.
