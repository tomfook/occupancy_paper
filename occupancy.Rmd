...
Since friend groups must sit together in the same row and cannot be split, groups of size $k > n$ cannot exist in this single-row model.
Therefore, we assume $p_k = 0$ for all $k > n$.
