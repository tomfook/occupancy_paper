...
$$
\begin{pmatrix}p_1\\p_2\\p_3\\p_4\end{pmatrix}=\begin{pmatrix}1/10\\1/3\\1/3\\1/3\end{pmatrix}.
$$
In the case,
```{r compare_single}
...
#### Extra: minimum occupancy without single arrival
...
#### Question
When we configure two queues, is it optimal to separate singles and the others?
By calculating every pattern, we would find out the optimal.
