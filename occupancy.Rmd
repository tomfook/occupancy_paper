...
grViz("
  digraph dot{
    graph[
      label = 'Fig.4: One line, four seats. \nRed means dispatch',
      fontsize = 10
    ];
    node[
      shape = circle,
...
#### Corollary: minimum occupancy without single arrival
...
$$
\frac{\partial}{\partial p_2}\mathrm E[Ocp|s_i\neq1]=0\\
\frac{\partial}{\partial p_3}\mathrm E[Ocp|s_i\neq1]=0\\
\frac{\partial}{\partial p_4}\mathrm E[Ocp|s_i\neq1]=0.
$$
